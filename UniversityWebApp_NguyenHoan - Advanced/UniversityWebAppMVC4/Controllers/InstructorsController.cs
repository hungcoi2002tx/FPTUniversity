...
namespace UniversityWebAppMVC4.Controllers
{
    public class InstructorsController : Controller
    {
        private readonly SchoolContextDBContext _context;

        public InstructorsController(SchoolContextDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Instructors != null ? 
                          ...
                          Problem("Entity set 'SchoolContextDBContext.Instructors'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolContextDBContext.Instructors'  is null.");
            }
            var instructor = await _context.Instructors.FindAsync(id);
            if (instructor != null)
            {
